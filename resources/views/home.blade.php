...
<body class="bg-[#ffffff] relative text-[#1b1b18]">
    ...
    <section class="w-full flex items-center justify-center px-4 flex-col py-10 ">
        ...
        <div class="w-full max-w-screen-xl">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-9">
                @forelse($medievalBuilds as $build)
                <a href="{{ route('build.show', $build->build_id) }}" class="bg-neutral-primary-soft w-full border-2 border-black shadow-[0_3px_0_0_black] transition-all duration-200 hover:translate-y-[2px] hover:shadow-[0_1px_0_0_black] hover:border-blue-500 hover:shadow-[0_1px_0_0_rgb(59,130,246)] block group">
                    <div class="h-60 w-full overflow-hidden">
                        <img class="w-full h-full object-cover transition-transform duration-300 group-hover:scale-105" src="{{ asset('storage/' . $build->cover_image) }}" alt="{{ $build->title }}" />
                    </div>
                ...
                @empty
                <p class="text-body col-span-4">No Medieval builds yet.</p>
                @endforelse
            </div>
        </div>
    </section>
    ...
    <section class="w-full flex items-center justify-center px-4 flex-col py-10 ">
        <div class="w-full max-w-screen-xl py-5 flex gap-4">
            <h4 class=" text-3xl font-bold tracking-tighter text-heading md:text-3xl lg:text-4xl">Modern Builds</h4>
        </div>
        <div class="w-full max-w-screen-xl">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-9">
                @forelse($modernBuilds as $build)
                <a href="{{ route('build.show', $build->build_id) }}" class="bg-neutral-primary-soft w-full border-2 border-black shadow-[0_3px_0_0_black] transition-all duration-200 hover:translate-y-[2px] hover:shadow-[0_1px_0_0_black] hover:border-blue-500 hover:shadow-[0_1px_0_0_rgb(59,130,246)] block group">
                    <div class="h-60 w-full overflow-hidden">
                        <img class="w-full h-full object-cover transition-transform duration-300 group-hover:scale-105" src="{{ asset('storage/' . $build->cover_image) }}" alt="{{ $build->title }}" />
                    </div>
                ...
                @empty
                <p class="text-body col-span-4">No Modern builds yet.</p>
                @endforelse
            </div>
        </div>
    </section>
    ...
    <section class="w-full flex items-center justify-center px-4 flex-col py-10 ">
        ...
        <div class="w-full max-w-screen-xl">
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-9">
                @foreach($topBuilders as $user)
                <a href="{{ route('profile.show', $user->username) }}" class="flex flex-col items-center justify-center gap-4">
                    <div class="w-full max-w-38 h-38 border-2 border-black">
                        <img class="w-full h-full object-center object-cover" src="{{ asset('images/' . $user->image) }}" alt="{{ $user->username }}">
                    </div>
                    <h5 class="text-2xl font-semibold tracking-tight text-heading">{{ $user->username }}</h5>
                </a>
                @endforeach
            </div>
        </div>
